                      ...
                      <td style="background-color:#ffffff;border-radius:16px;vertical-align:top;padding:16px 0px;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          <tbody>
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:KHTeka, Helvetica, sans-serif;font-size:16px;font-weight:400;line-height:19.2px;text-align:left;color:#88869F;">{{verify_email_click_to_verify}}</div>
                              </td>
                            </tr>
                            <tr>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="center" bgcolor="{{buttonColor}}" role="presentation" style="border:none;border-radius:6px;cursor:auto;mso-padding-alt:15px 25px;background:{{buttonColor}};" valign="middle">
                                        <a href="{{emailValidationUrl}}" style="display:inline-block;background:{{buttonColor}};color:#ffffff;font-family:KHTeka, Helvetica, sans-serif;font-size:16px;font-weight:normal;line-height:20px;margin:0;text-decoration:none;text-transform:none;padding:15px 25px;mso-padding-alt:0px;border-radius:6px;" target="_blank">
                                          {{verify_email_verify}}
                                        </a>
                                      </td>
                                    </tr>
