...
export const users = new OpenAPIHono<{ Bindings: Env }>()
  ...
  .openapi(
    ...
    async (ctx) => {
      ...
      const user = await ctx.env.data.users.get(tenant_id, id);
  ...
  .openapi(
    ...
    async (ctx) => {
      ...
      const result = await ctx.env.data.users.remove(tenant_id, id);
  ...
  .openapi(
    ...
    async (ctx) => {
      ...
      const userToPatch = await ctx.env.data.users.get(tenant_id, id);
      ...
      const result = await ctx.env.data.users.update(tenant_id, id, userFields);
      ...
      const patchedUser = await ctx.env.data.users.get(tenant_id, id);
  ...
  .openapi(
    ...
    async (ctx) => {
      ...
      await ctx.env.data.users.unlink(tenant_id, id);
